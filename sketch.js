...
function setup () {
  ...
  var flowerThree = new FancyFlower(width/3 - 40, 3 * height/4, blue);
  var flowerFour = new FancyFlower(width/3 - 80, 3 * height/4, green);
...
class FancyFlower {
  constructor(x, y, petalColor) {
    ...
    this.bloomSpeed = random(1, 2);
    this.maxBloomSize = random(75, 150);
  }
